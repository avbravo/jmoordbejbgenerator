...
public final class JmoordbEJBGeneratorVisualPanel3 extends JPanel {
     ...
     */
    public JmoordbEJBGeneratorVisualPanel3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (jTableModulos.getColumnModel().getColumnCount() > 0) {
            jTableModulos.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jTableModulos.columnModel.title0")); // NOI18N
            jTableModulos.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jTableModulos.columnModel.title1")); // NOI18N
            jTableModulos.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jTableModulos.columnModel.title2")); // NOI18N
            jTableModulos.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jTableModulos.columnModel.title3")); // NOI18N
        }

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel22.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel22, org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jLabel22.text")); // NOI18N

        jButtonCheckCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/avbravo/jmoordbejbgenerator/resources/check_box.png"))); // NOI18N
        jButtonCheckCreate.setToolTipText(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jButtonCheckCreate.toolTipText")); // NOI18N
        ...
        jButtonUnCheckCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/avbravo/jmoordbejbgenerator/resources/checkbox_no.png"))); // NOI18N
        jButtonUnCheckCreate.setToolTipText(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jButtonUnCheckCreate.toolTipText")); // NOI18N
        ...
        jButtonCheckEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/avbravo/jmoordbejbgenerator/resources/check_box.png"))); // NOI18N
        jButtonCheckEdit.setToolTipText(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jButtonCheckEdit.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel25, org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jLabel25.text")); // NOI18N

        jButtonUnCheckEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/avbravo/jmoordbejbgenerator/resources/checkbox_no.png"))); // NOI18N
        jButtonUnCheckEdit.setToolTipText(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jButtonUnCheckEdit.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel24, org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jLabel24.text")); // NOI18N

        jButtonCheckList.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/avbravo/jmoordbejbgenerator/resources/check_box.png"))); // NOI18N
        jButtonCheckList.setToolTipText(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jButtonCheckList.toolTipText")); // NOI18N
        ...
        jButtonUnCheckList.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/avbravo/jmoordbejbgenerator/resources/checkbox_no.png"))); // NOI18N
        jButtonUnCheckList.setToolTipText(org.openide.util.NbBundle.getMessage(JmoordbEJBGeneratorVisualPanel3.class, "JmoordbEJBGeneratorVisualPanel3.jButtonUnCheckList.toolTipText")); // NOI18N
