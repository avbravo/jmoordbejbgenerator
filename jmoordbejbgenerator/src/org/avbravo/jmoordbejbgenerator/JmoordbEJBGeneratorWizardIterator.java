...
import org.avbravo.jmoordbejbgenerator.generales.Directorios;
import org.avbravo.jmoordbejbgenerator.generales.MySession;
import org.avbravo.jmoordbejbgenerator.proyecto.ProyectoInformacion;
import org.avbravo.jmoordbejbgenerator.utilidades.Utilidades;
...
import org.avbravo.jmoordbejbgenerator.beans.Clases;
import org.avbravo.jmoordbejbgenerator.layout.CssLayout;
import org.avbravo.jmoordbejbgenerator.layout.DefaultCss;
import org.avbravo.jmoordbejbgenerator.parameters.Parameters;
import org.avbravo.jmoordbejbgenerator.temas.UpdateCambiadorTemas;
import org.avbravo.jmoordbejbgenerator.temas.UpdateTemasWebXML;
import org.avbravo.jmoordbejbgenerator.xhtml.IndexXhmtl;
import org.avbravo.jmoordbejbgenerator.xhtml.JsfComposite;
import org.avbravo.jmoordbejbgenerator.xhtml.JsfListPaginas;
import org.avbravo.jmoordbejbgenerator.xhtml.JsfPaginas;
import org.avbravo.jmoordbejbgenerator.xhtml.Loginxhtml;
import org.avbravo.jmoordbejbgenerator.xhtml.Menuxhtml;
import org.avbravo.jmoordbejbgenerator.xhtml.MyPrimeFaces;
import org.avbravo.jmoordbejbgenerator.xhtml.SessionExpiredXhtml;
import org.avbravo.jmoordbejbgenerator.xhtml.TemplateFacelets;
import org.netbeans.api.templates.TemplateRegistration;

// TODO define position attribute
@TemplateRegistration(folder = "JSF", displayName = "#JSFGeneratorWizardIterator_displayName", iconBase = "org/avbravo/jmoordbejbgenerator/resources/ejb16.png", description = "JMoordbEJBGenerator.html")
@Messages("JSFGeneratorWizardIterator_displayName=Jmoordbejbgenerator")
public final class JmoordbEJBGeneratorWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
...
//    String parametrosTemaPrimefaces = "";
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        ...
        if (MySession.isEsProyectoWeb()) {
            ...
            if (panels == null) {
                ...
                panels.add(new JmoordbEJBGeneratorWizardPanel1());
                panels.add(new JmoordbEJBGeneratorWizardPanel2());
                panels.add(new JmoordbEJBGeneratorWizardPanel3());
                panels.add(new JmoordbEJBGeneratorWizardPanel4());
                panels.add(new JmoordbEJBGeneratorWizardPanel5());
    ...
    public Set<?> instantiate() throws IOException {
        ...
        if (growlsSeconds.equals("")) {
            DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoValidSecond"));
            return null;
        }
    ...
    public void initialize(WizardDescriptor wizard) {
        try {
            ...
            if (projectInformation.getInformation(DGlobal.getProject())) {
                if (!MySession.isEsProyectoWeb()) {
                    DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensaje_ProyectoNoSeleccionado"));
...
//((WizardDescriptor) wizard).putProperty("facelesTemplate", "superior_izquierda_derecha");
    ...
    private void procesar() {
        try {
             ...
             */
            if (ficheros == null) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensaje_NoArchivoPropiedades"));
                return;
            }
            String dirResources = MySession.getWeb() + MySession.getFileSeparator() + "resources";
            if (Utilidades.crearDirectorio(dirResources)) {
            } else {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoCreateFolderResources"));
                return;
            }
            ...
            if (Utilidades.crearDirectorio(dirResourcesCss)) {
                ...
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoCreateFolderCss"));
                return;
            }
            ...
            if (MySession.getFaceletsTemplate() == null || MySession.getFaceletsTemplate().equals("")) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoTemplateDesing"));
                return;
            ...
            if (Utilidades.encontrarTextoArchivo(rutaArchivoPlantilla, "<link href=\"./resources/css/default.css\" rel=\"stylesheet\" type=\"text/css\" />")) {
                ...
                if (!Utilidades.actualizaTextoArchivo(rutaArchivoPlantilla, "<link href=\"./resources/css/default.css\" rel=\"stylesheet\" type=\"text/css\" />", link)) {
                    DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoDefaultCSS"));
                }
            }
            if (Utilidades.encontrarTextoArchivo(rutaArchivoPlantilla, "<link href=\"./resources/css/cssLayout.css\" rel=\"stylesheet\" type=\"text/css\" />")) {
                ...
                if (!Utilidades.actualizaTextoArchivo(rutaArchivoPlantilla, "<link href=\"./resources/css/cssLayout.css\" rel=\"stylesheet\" type=\"text/css\" />", link)) {
                    DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoLayoutCSS"));
                }
            }
            ...
            if (!isProperties(rutaArchivoPropiedades)) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoTituloPropiedad"));
                return;
            }
    ...
    private void generar() {
        try {
            ...
            if (DGlobal.getTemaInicial().equals(temaPrimefaces) && !DGlobal.getReplaceMenu() && !DGlobal.getReplaceTemplate() && !DGlobal.getReplaceIndex() && !seleccionoPaginas) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoPagesSelected"));
                return;
            }
             ...
             */
            if (dirBeans == null) {
                DGlobal.informacion(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoJavaBeans"));
                return;
            }
            ...
            if (ficherosController == null) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoController"));
                return;
            }
            /*
            ...
            if (ficherosWebInf == null) {
                ...
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoArchivosWebINF"));
                return;
            }
            ...
            if (!bweb) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoWebXML"));
                return;
            }
            if (!bcontext) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoContextXML"));
                return;
            }
            if (!bbeans) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoBeansXML"));
                return;
            }
            /*
            ...
            if (!isWebXMLJDBC(MySession.getDirectorioWebInf() + MySession.getFileSeparator() + "web.xml")) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_WebXMLNoData"));
                return;
            }
            if (!isContextXMLJDBC(MySession.getDirectorioWebInf() + MySession.getFileSeparator() + "context.xml")) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_ContextNoData"));
                return;
            }
            ...
            if (!Utilidades.crearDirectorio(directorioModulo)) {
                DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensaje_NoDirectorioModulos"));
                return;
            }
            /*
             * genera el menu
...
//                                    menuPrimefaces.append("\n                   <p:menuitem value=\"" + "#{mensajes['menu." + lcrud.toLowerCase() + "']}" + "\" url=\"" + urlFaces + "\" rendered=\"#{" + rendered + "}\" icon=\"" + icono + "\" />");
                        ...
                        DGlobal.advertencia(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_NoDirectorio") + Utilidades.convertirLetraMayuscula(archivo));
                    }
                }
            }//for archivolist
            ...
            DGlobal.informacion(NbBundle.getMessage(JmoordbEJBGeneratorWizardIterator.class, "Mensajes_Completo"));
