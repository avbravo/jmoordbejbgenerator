 ...
 */
package org.avbravo.jmoordbejbgenerator.xhtml;
 ...
 * @author avbravo
 */
public class SessionExpiredXhtml {
     ...
     */
    public static void addSessionExpiredFile() {
        try {
            String directorioWebIndex = MySession.getWeb() + MySession.getFileSeparator() + "sessionexpired.xhtml";
    ...
    private static void generarContenido() {
        try {
            ...
            salida.println("\n         <f:facet name=\"header\">");
            salida.println("\n           <h:outputLabel  value=\"#{" + MySession.getVar() + "['msg.sesionexpiredtitle']}\"/>");
            salida.println("\n        </f:facet>");
            salida.append("\n        <h:outputText value=\"#{mensajes['msg.sesionexpiredtitle']}\"></h:outputText>");
            
            salida.println("\n         <f:facet name=\"footer\">");
            salida.append("\n        <p:commandButton action=\"/index.xhtml\" value=\"#{mensajes['boton.home']}\" ajax = \"false\" />");
            salida.println("\n        </f:facet>");
            salida.append("\n   </h:panelGrid>");
 salida.append("\n   </p:dialog>");
            salida.append("\n");
